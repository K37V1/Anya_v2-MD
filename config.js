...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "ルルーシュ・ヴィ・ブリタニア ",
    ownernumber: process.env.Owner_Number || "+233594428498",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://beatray:123490@cluster0.bpoad.mongodb.net/",
    sessionId: process.env.SESSION_ID || "dTAwaGc_Queen-Anya_0c_Queen-Anya_TY=",
